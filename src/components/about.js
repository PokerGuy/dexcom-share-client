                    ...
                    <div className="panel panel-default">
                        ...
                        <div className="panel-body">
                            <div className="text-left col-sm-12">
                                ...
                                I currently make no attempt at HIPAA privacy compliance. Use of this code is without warranty or support of any kind. <br/>
                                Use at your own risk, and do not use the information or code to make medical decisions. <br/>
                            </div>
                        </div>
                    </div>
                </div>
